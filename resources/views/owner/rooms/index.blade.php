...
<div class="p-6">
    ...
    <div class="mb-5 flex items-start gap-3 bg-amber-50 border border-amber-200 text-amber-800 rounded-xl px-4 py-3 text-sm">
        ...
        <span>Hotel đang chờ admin duyệt. Rooms sẽ hiển thị công khai sau khi hotel được approve.</span>
    </div>
    @endif
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
        ...
        <div class="text-center py-16 text-gray-400">
            ...
            <p class="text-sm font-medium text-gray-500 mb-1">No rooms yet</p>
        ...
        <table class="w-full text-sm">
            <thead class="bg-gray-50 border-b border-gray-200">
                <tr>
                    <th class="text-left px-5 py-3 text-xs font-medium text-gray-500 uppercase tracking-wide">Room</th>
                    <th class="text-left px-5 py-3 text-xs font-medium text-gray-500 uppercase tracking-wide">Type</th>
                    <th class="text-left px-5 py-3 text-xs font-medium text-gray-500 uppercase tracking-wide">Capacity</th>
                    <th class="text-left px-5 py-3 text-xs font-medium text-gray-500 uppercase tracking-wide">Price/night</th>
                    <th class="text-left px-5 py-3 text-xs font-medium text-gray-500 uppercase tracking-wide">Quantity</th>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-5 py-4 text-gray-600">{{ $room->max_guests }} guests</td>
                    ...
                    <td class="px-5 py-4">
                        <div class="flex items-center gap-2 justify-end">
                            ...
                            <form action="{{ route('owner.rooms.delete', $room->id) }}" method="POST"
                                ...
                                @csrf @method('DELETE')
                                <button type="submit"
                                    class="px-3 py-1.5 rounded-lg text-red-500 hover:bg-red-50 text-xs font-medium transition">
                                    Delete
                                </button>
                            </form>
                        </div>

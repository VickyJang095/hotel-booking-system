...
<section class="max-w-7xl mx-auto px-4 pt-16 scroll-animate fade-up">
    <h2 class="text-[35px] font-bold mb-5">{{ __('home.top_things_barcelona') }}</h2>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
        <div class="group cursor-pointer">
            ...
            <h3 class="font-semibold text-sm">{{ __('home.sagrada_familia') }}</h3>
        </div>

        <div class="group cursor-pointer">
            <div class="relative rounded-2xl overflow-hidden mb-3 aspect-square">
                <img src="https://images.unsplash.com/photo-1539037116277-4db20889f2d4?w=400&q=80" alt="Park Guell" alt="Park Guell" class="w-full h-full object-cover group-hover:scale-110 transition duration-300">
            </div>
            <h3 class="font-semibold text-sm">{{ __('home.park_guell') }}</h3>
        </div>
        ...
        <div class="group cursor-pointer">
            ...
            <h3 class="font-semibold text-sm">{{ __('home.casa_mila') }}</h3>
        </div>
        ...
        <div class="group cursor-pointer">
            ...
            <h3 class="font-semibold text-sm">{{ __('home.sacred_heart_temple') }}</h3>
        </div>
        ...
        <div class="group cursor-pointer">
            ...
            <h3 class="font-semibold text-sm">{{ __('home.arc_de_triomphe') }}</h3>
        </div>
        ...
        <div class="group cursor-pointer">
            ...
            <h3 class="font-semibold text-sm">{{ __('home.casa_batllo') }}</h3>
        </div>
    </div>
</section>

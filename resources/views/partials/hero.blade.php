                ...
                <div class="bg-white rounded-4xl p-10 py-12 search-card shadow-lg">
                    <div class="flex space-x-3 pt-3">
                        ...
                        <div class="pr-12 border-r border-gray-400">
                            ...
                            <input name="location" type="text" id="location" placeholder="Where are you going?" class="w-full text-[16px] px-4 py-3 border-none text-gray-500">
                        </div>
                        ...
                        <div class="border-r border-gray-400 pr-6">
                            ...
                            <input type="date" name="check_in" id="checkin" placeholder="Add Dates" class="w-full px-4 py-3 border-none text-gray-500 text-[16px]">
                        </div>

                        <!-- Check Out -->
                        <div class="border-r border-gray-400 pr-6">
                            <label class="block text-[18px] font-semibold text-gray-700 text-start px-4">Check Out</label>
                            <input type="date" name="check_out" id="checkout" placeholder="Add Dates" class="w-full px-4 py-3 border-none text-gray-500 text-[16px]">
                        </div>
                        ...
                        <div class="flex justify-end m-3">
                            <button type="submit" class="flex items-center space-x-2 px-4 bg-blue-600 text-white text-[20px] rounded-xl font-semibold hover:bg-blue-700 transition">
...
<script>
    ...
    function change(type, value) {
        ...
        // Sync hidden inputs cho form submit
    ...
    function updateGuestText() {
        ...
        document.getElementById('guestText').innerText =
            `${r} room${r > 1 ? 's' : ''}, ${a} adult${a > 1 ? 's' : ''}, ${c} children`;
    }

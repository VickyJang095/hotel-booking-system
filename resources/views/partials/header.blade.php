        ...
        <div class="relative flex h-24 items-center justify-between">
            ...
            <div class="absolute inset-y-0 right-0 flex items-center space-x-2 pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <button type="button" onclick="openLocaleModal('languages')"
                        class="flex items-center gap-2 px-5 py-4 rounded-xl hover:bg-gray-100 transition">
                        <img src="https://flagcdn.com/w20/{{ app()->getLocale() === 'vi' ? 'vn' : 'us' }}.png"
                            class="w-6 h-5 object-cover rounded-sm" alt="">
                    ...
                    <el-dropdown class="relative ml-3">
                        <button type="button" class="relative flex rounded-full">
                        ...
                        <el-menu anchor="bottom end" popover class="w-56 rounded-2xl bg-white shadow-xl border border-gray-100 py-2 z-50">
                            ...
                            <a href="{{ route('owner.dashboard') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-blue-600 font-medium hover:bg-blue-50 transition">
                                ...
                                {{ __('common.owner_dashboard') }}
                            </a>
                            <div class="my-1 border-t border-gray-100"></div>
                            @endif

                            <a href="{{ route('profile.show') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                </svg>
                                {{ __('common.personal_data') }}
                            </a>
                            <a href="{{ route('profile.show') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('profile.trips') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-x-4 flex items-center">
                    {{-- Language/Currency button --}}
                    <button type="button" onclick="openLocaleModal('languages')"
                        class="flex items-center gap-2 px-3 py-1.5 rounded-xl hover:bg-gray-100 transition">
                        <img src="https://flagcdn.com/w20/{{ app()->getLocale() === 'vi' ? 'vn' : 'us' }}.png"
                    ...
                    <button type="button" command="show-modal" commandfor="auth-dialog"
                        class="rounded-2xl px-6 py-2 text-base font-semibold text-white bg-[#0057FF] hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-yellow-500">
                        {{ __('common.login') }}
                    </button>
                </div>
                @endguest

...
@section('title', __('admin.become_owner_title'))
...
<div class="min-h-screen bg-gray-50 py-12">
    <div class="max-w-2xl mx-auto px-4">
        ...
        <div class="text-center mb-10">
            ...
            <h1 class="text-3xl font-bold text-gray-900">{{ __('admin.become_owner_title') }}</h1>
            <p class="text-gray-500 mt-2">{{ __('admin.become_owner_sub') }}</p>
        </div>
        ...
        <div class="mb-6 flex items-start gap-3 bg-red-50 border border-red-200 text-red-800 rounded-xl px-4 py-3">
            <svg class="w-5 h-5 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm-1-9v4a1 1 0 102 0V9a1 1 0 10-2 0zm0-4a1 1 0 112 0 1 1 0 01-2 0z" clip-rule="evenodd"/></svg>
        ...
        <div class="bg-white rounded-2xl border border-amber-200 p-8 text-center">
            ...
            <h2 class="text-xl font-semibold text-gray-900 mb-2">{{ __('admin.application_pending') }}</h2>
            <p class="text-gray-500 text-sm mb-4">{{ __('admin.application_sent') }}</p>
            ...
            <form action="{{ route('owner-request.store') }}" method="POST" class="p-8 space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div class="sm:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">{{ __('admin.hotel_name_label') }} <span class="text-red-500">*</span></label>
                        <input type="text" name="hotel_name" value="{{ old('hotel_name') }}"
                            placeholder="VD: Khách sạn Bình Minh"
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">{{ __('admin.phone') }} <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">{{ __('admin.city') }} <span class="text-red-500">*</span></label>
                    ...
                    <div class="sm:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">{{ __('admin.address') }}</label>
                    ...
                    <div class="sm:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">{{ __('admin.description') }}</label>
                        <textarea name="description" rows="4"
                            placeholder="Mô tả tài sản, tiện nghi, điểm nổi bật..."
                ...
                <div class="pt-2">
                    <button type="submit" class="w-full rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 text-sm transition">
                        {{ __('admin.submit_application') }}
                    </button>
                    <p class="text-center text-xs text-gray-400 mt-3">Bằng cách gửi, bạn đồng ý với Điều khoản dịch vụ của chúng tôi.</p>
                </div>
            </form>
        </div>
        @endif

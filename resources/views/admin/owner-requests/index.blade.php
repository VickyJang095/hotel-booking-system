...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-xl font-semibold text-gray-900">Owner Requests</h1>
            <p class="text-sm text-gray-500 mt-0.5">Review and approve hotel owner applications</p>
        </div>
        {{-- Filter --}}
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
        ...
        <table class="w-full text-sm">
            <thead class="bg-gray-50 border-b border-gray-200">
                <tr>
                    <th class="text-left px-5 py-3 text-xs font-medium text-gray-500 uppercase tracking-wide">Applicant</th>
